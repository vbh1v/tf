            ...
            <div className="flex items-center justify-center" data-oid="__kt:p1">
                ...
                <div className="relative" data-oid="3u2fuc1">
                    ...
                    >
                        ...
                        <div
                            className="w-40 h-32 border border-green-400/40 rounded-lg flex flex-col items-center justify-center mt-12 mb-4 relative overflow-hidden"
                            data-oid="u8b63vk"
                            key="olk-Qpea"
                        >
                            {/* Barcode lines */}
                        ...
                        {/* Home Button / Scanner */}
                        <div
                            className="absolute bottom-6 w-10 h-10 border border-green-400/40 rounded-full flex items-center justify-center cursor-pointer"
                            data-oid="bkjc3h3"
                            key="olk-3Ycj"
                        ...
                        {/* Scanner Label */}
                        <div className="absolute bottom-0 transform translate-y-6 text-xs text-green-400/80 font-mono">
                            scanner
                        </div>
                    </div>
                </div>
